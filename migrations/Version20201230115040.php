 ...
 */
final class Version20201230115040 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO `actor` (`firstname`, `lastname`) VALUES ("Andrew", "Lincoln");');
        $this->addSql('INSERT INTO `actor` (`firstname`, `lastname`) VALUES ("Norman", "Reedus");');
        $this->addSql('INSERT INTO `actor` (`firstname`, `lastname`) VALUES ("Lauren", " Cohan");');
        $this->addSql('INSERT INTO `actor` (`firstname`, `lastname`) VALUES ("Danai", " Gurira");');
    }
